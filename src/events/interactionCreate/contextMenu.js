module.exports = {
  execute(client, interaction) {
    ...
    if (contextMenu.permissions && !interaction.channel.permissionsFor(interaction.user).has(contextMenu.permissions)) return interaction.reply({content: `Missing permissions: \`${contextMenu.permissions.join("|")}\``, ephemeral: true});
